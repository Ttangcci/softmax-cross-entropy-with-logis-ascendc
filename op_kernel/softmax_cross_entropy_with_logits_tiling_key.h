...
ASCENDC_TPL_ARGS_DECL(SoftmaxCrossEntropyWithLogits,
    ASCENDC_TPL_UINT_DECL(schMode, 1, ASCENDC_TPL_UI_LIST, SCH_MODE_FLOAT, SCH_MODE_FLOAT16));

ASCENDC_TPL_SEL(ASCENDC_TPL_ARGS_SEL(
    ASCENDC_TPL_UINT_SEL(schMode, ASCENDC_TPL_UI_LIST, SCH_MODE_FLOAT, SCH_MODE_FLOAT16)));
